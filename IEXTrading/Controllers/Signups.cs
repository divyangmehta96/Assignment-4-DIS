...
{
    public class Signups : Controller
    {
        private readonly ApplicationDbContext _context;

        public Signups(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,customer_id,first_name,last_name,age,Email")] Signup signup)
        {
